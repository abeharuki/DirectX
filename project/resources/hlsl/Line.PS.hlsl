...
PixelShaderOutput main(VertexShaderOutput input)
{
    ...
    if (gMaterial.enableLighting != 0)
    {
        ...
        float32_t3 diffuse = gMaterial.color.rbg * gLight.directionLight.color.rgb * cos * gLight.directionLight.intensity;
        ...
        if (gLight.pointLight.isEnable != 0)
        {
            ...
            float32_t3 pDiffuse = gMaterial.color.rgb * pointLightColor * pCos;
        ...
        if (gLight.spotLight.isEnable != 0)
        {
            ...
            float32_t3 sDiffuse = gMaterial.color.rgb * spotLightColor * sCos;
